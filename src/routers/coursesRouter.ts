...
export const coursesRouter = (router: Router, configs: Configs, prismaClient: PrismaClient) => {
  const path = configs.routerPath;
  ...
  router.get(`${path}/courses/topics/:topic`, async (req: Request, res: Response) => {
